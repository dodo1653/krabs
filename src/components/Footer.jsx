    ...
    <footer className="py-8 border-t" style={{ borderColor: 'rgba(255,255,255,0.05)' }}>
      <div className="terminal-container">
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 mb-4">
          <p className="text-lg font-medium">$JAWAD</p>
          <div className="flex items-center gap-4">
            ...
            <a href="https://x.com/i/communities/2025543066569056377" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1.5 text-xs transition-colors hover:text-white" style={{ color: 'var(--color-text-muted)' }}>
