      ...
      <div className="terminal-container relative">
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 mb-4">
          ...
          <div className="flex items-center gap-4">
            ...
            <a href="https://x.com/MrKrabsAI" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1.5 text-xs transition-colors hover:text-white" style={{ color: 'var(--color-text-muted)' }}>
